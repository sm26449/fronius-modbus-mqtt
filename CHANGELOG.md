...
|---------|------|------------|
| 1.7.0 | 2026-04-27 | Built-in HTTP monitoring dashboard with dark-theme UI and JSON API |
| 1.6.0 | 2026-04-27 | Power limit control via MQTT, vendor status to InfluxDB, shutdown safety |
